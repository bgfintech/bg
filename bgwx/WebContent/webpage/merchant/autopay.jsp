                    ...
                    <div class="ibox-title">
                        <div class="form-inline">
                            <div class="col-xs-12">
                                ...
                                <div class="form-group posr">
                                   <label class="control-label" style="width:60px">预留电话</label>
                                   <input type="text" class="form-control"/>
                                </div>
                                <div class="form-group posr">
                                   <label class="control-label" style="width:60px">银行卡号</label>
                                   <input type="text" class="form-control" />
                                </div>
                                 <div class="form-group posr">
                                   <button type="button" class="btn btn-warning"  onclick="smscode('-1')">发送签约短信</button>
                                </div>
                            </div>
                        ...
                        <div class="form-inline">
                            <div class="col-xs-12">
                            	<div class="form-group posr">
                                   <label class="control-label" style="width:60px">验证码</label>
                                   <input type="text" class="form-control" name="smscode" id="smscode"/>
                                </div>                    
                            	<div class="form-group posr">
                                    <button type="button" class="btn btn-warning"  onclick="confirm('-1')">签约确认</button>
                                </div>                               
                            </div>
                            <div class="col-xs-12"></div>
                        </div>
