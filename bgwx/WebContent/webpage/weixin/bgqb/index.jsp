...
<head>
    ...
    <link rel="stylesheet" href="plug-in/leaRun/js/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="plug-in/leaRun/css/font-awesome.min.css">
    <link rel="stylesheet" href="plug-in/css/index.css">
    <link rel="stylesheet" href="plug-in/css/skins/_all-skins.css">
</head>
<body class="hold-transition skin-blue sidebar-mini" style="overflow:hidden;">
    <div id="ajax-loader" style="cursor: progress; position: fixed; top: -50%; left: -50%; width: 200%; height: 200%; background: #fff; z-index: 10000; overflow: hidden;">
        <img src="plug-in/leaRun/img/ajax-loader.gif" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; margin: auto;" />
    </div>
    <div class="wrapper">
        <!--头部信息-->
        <header class="main-header">
            <a href="http://www.learun.cn/adms/index.html" target="_blank" class="logo">
                <span class="logo-mini">恒支付</span>
                <span class="logo-lg">learun<strong>聚合支付商户管理平台</strong></span>
            </a>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="plug-in/leaRun/img/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <div class="sidebar">
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="plug-in/leaRun/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                    </div>
            ...
            <div class="content-tabs">
                ...
                <nav class="page-tabs menuTabs">
                    <div class="page-tabs-content" style="margin-left: 0px;">
                        ...
                        <a href="javascript:;" class="menuTab" data-id="/SystemManage/User/Index">用户管理 <i class="fa fa-remove"></i></a>
                        <a href="javascript:;" class="menuTab" data-id="/SystemManage/User/Index">商户管理 <i class="fa fa-remove"></i></a>
                    </div>
    ...
    <script src="plug-in/leaRunjs/jquery/jQuery-2.2.0.min.js"></script>
    <script src="plug-in/leaRun/js/bootstrap/js/bootstrap.min.js"></script>
    <script src="plug-in/leaRun/js/index.js"></script>
</body>
</html>
