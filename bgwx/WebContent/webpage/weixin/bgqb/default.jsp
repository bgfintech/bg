...
<head>
    ...
    <link rel="stylesheet" href="plug-in/leaRun/css/index.css">
    <script src="plug-in/leaRun/js/jquery/jQuery-2.2.0.min.js"></script>
    <script src="plug-in/leaRun/js/charts/Chart.js"></script>
    <script>
        $(function () {
            Canvas1();
            Canvas2();
