...
<html lang="en">
    ...
    <body>
    <form id="transform" action="transController.do?txscanPay" method="post">
	    ...
	    <input id="payChannel" name="payChannel" type="hidden" value="02" />
		...
		<div class="other_pay">
		  ...
		  <!-- 
		    ...
		    <li class="other_pay_item clearfix">
		      ...
		      <a href="javascript:;" class="other_pay_itemR_on other_pay_itemR fr" check="false"></a>
		    </li>
		    <!-- 
		    <li class="other_pay_item clearfix">
