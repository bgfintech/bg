...
public class Trans111Rsp {
	...
	private String card_verify_type;
	...
	public String getCard_verify_type() {
		return card_verify_type;
	}
	public void setCard_verify_type(String card_verify_type) {
		this.card_verify_type = card_verify_type;
	}
