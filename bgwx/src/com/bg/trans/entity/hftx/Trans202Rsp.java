...
public class Trans202Rsp {
	...
	public String getReal_trans_amt() {
		return real_trans_amt;
	}
	public void setReal_trans_amt(String real_trans_amt) {
		this.real_trans_amt = real_trans_amt;
	}
	public String getCash_bind_card_id() {
		return cash_bind_card_id;
	}
	public void setCash_bind_card_id(String cash_bind_card_id) {
		this.cash_bind_card_id = cash_bind_card_id;
	}
