...
public class Preservation {
	...
	private String n_sqbqse_level;//申请保全数额等级
	private String n_sqbqse;//申请保全数额
	private String c_sqbqbdw;//申请保全标地物
	...
	public String getN_sqbqse_level() {
		return n_sqbqse_level;
	}
	public void setN_sqbqse_level(String n_sqbqse_level) {
		this.n_sqbqse_level = n_sqbqse_level;
	}
	public String getN_sqbqse() {
		return n_sqbqse;
	}
	public void setN_sqbqse(String n_sqbqse) {
		this.n_sqbqse = n_sqbqse;
	}
	public String getC_sqbqbdw() {
		return c_sqbqbdw;
	}
	public void setC_sqbqbdw(String c_sqbqbdw) {
		this.c_sqbqbdw = c_sqbqbdw;
	}
