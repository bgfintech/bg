...
//					}
	...
	@Override
	public String getJsApiInfo(WeixinAccountEntity weixinAount,
			SystemService systemService, String url) {
		// TODO Auto-generated method stub
		        ...
		        // 获取jsapi_ticket
		        /*JSONObject jsonObject = WeixinUtil.httpRequest("https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token=" + WeixinUtil.getAccessToken(systemService, weixinAount.getAccountappid(), weixinAount.getAccountappsecret()).getToken() + "&type=jsapi", "GET", null);
		        ...
		        if(ticket != null && !"".equals(ticket) && start != null&& ((end.getTime() - start.getTime()) < (7199 * 1000))){
		        	...
		        	AccessToken accessToken = WeixinUtil.getAccessToken(systemService, weixinAount.getAccountappid(), weixinAount.getAccountappsecret());
		            // 获取jsapi_ticket
		            ...
		            this.saveOrUpdate(weixinAount);      
		        }     
		        
		        /**-------------------------------------------------------**/
		        String signature = SignUtil.createSignature(jsapi_ticket, nonceStr, timestamp, url);
		        return "{\"appId\":\"" + weixinAount.getAccountappid() + "\", \"timestamp\":" + timestamp + ", \"nonceStr\":\"" + nonceStr + "\", \"signature\":\"" + signature + "\"}";
	}
}