...
import weixin.guanjia.core.util.FreemarkerHelper;
		...
		try {
			...
			***/
			...
			//【微信触发类型】事件推送
				...
				LogUtil.info("---------------"+eventType);
				// 订阅
				if (eventType.equals(MessageUtil.EVENT_TYPE_SUBSCRIBE)) {
					String eventKey = requestMap.get("EventKey");
					QRCodeService.insertSubscribeLog(fromUserName,eventKey);
				...
				// 扫码
					...
					String eventKey = requestMap.get("EventKey");
					System.out.println("SCAN=================:"+eventKey);
					QRCodeService.insertSubscribeLog(fromUserName,eventKey);
				}
				// 取消订阅
