...
public class DaZhuanPanService implements KeyServiceI {
	...
	public String excute(String content, TextMessageResp defaultMessage,
		...
		article.setPicUrl("http://imnu.tunnel.qydev.com/jeewx/plug-in/weixin/images/activity-lottery-1.png");
		article.setUrl("http://imnu.tunnel.qydev.com/jeewx/zpController.do?goZhuanpan&accountid="+accountid+"&openId="+defaultMessage.getToUserName());
